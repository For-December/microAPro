...
import (
	...
	"microAPro/custom_plugin/constant"
	"net/http"
	"net/url"
	"strings"
)
...
func init() {
	appid = config.EnvCfg.BaiDuAppId
	key = config.EnvCfg.BaiDuSecretKey
	salt = config.EnvCfg.BaiDuSalt
	apiUrl = constant.BaiduTranslateEndPoint
}
